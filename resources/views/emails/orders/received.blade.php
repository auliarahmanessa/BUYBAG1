    ...
    <div style="background-color: #f7fafc; ">
        <div style="background-color: #ffffff; max-width: 600px; margin: 0 auto; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border-radius: 4px; overflow: hidden;">
            <div style="padding: 20px;">
                <h1 style="font-size: 24px; font-weight: bold; color: #abc4ff; margin-bottom: 16px;">Thank You for Your Purchase!</h1>
                ...
                <a href="{{ url('/dashboard') }}" style="background-color: #abc4ff; color: #ffffff; font-weight: bold; text-decoration: none; padding: 12px 24px; border-radius: 4px; display: inline-block;">View Your Order</a>
            </div>
            ...
            <a href="#" style="color: #abc4ff; text-decoration: none;">Shopi Contact Support</a>
        </div>
    </div>
</x-mail::message>

<x-app-layout>
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-red-100/40 p-8 rounded-3xl">
            <header class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-5xl font-bold text-blue-600">Invoice</h1>
                    <p class="text-md">Invoice #{{ $order->id }}</p>
                </div>
                <div>
                    <p class="text-blue-600 font-semibold">SHOPI</p>
                    <p>BUYBAG, ISMO</p>
                    <p>BUYBAG</p>
                    <p>BUYBAG@gmail.com</p>
                </div>
            </header>
            <div class="mb-8 text-lg">
                <p class="text-blue-600 font-semibold mb-2 text-xl">Bill To:</p>
            ...
            <table class="w-full text-left table-auto bg-white/60">
                <thead>
                    <tr>
                        <th class="px-4 py-2 text-blue-600">Product image</th>
                        <th class="px-4 py-2 text-blue-600">Product name</th>
                        <th class="px-4 py-2 text-blue-600">Quantity</th>
                        <th class="px-4 py-2 text-blue-600">Price</th>
                        <th class="px-4 py-2 text-blue-600">Total</th>
                    </tr>
                </thead>
                <tbody>
                ...
                <tfoot class="text-lg">
                    ...
                    <tr class="font-semibold text-blue-600">

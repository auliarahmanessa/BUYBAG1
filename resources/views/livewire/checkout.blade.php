                        ...
                        {{-- <form class="">
                            ...
                            <ul class="grid w-full gap-6 md:grid-cols-2">
                                <li>
                                    ...
                                    <label for="cod"
                                        class="inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border border-gray-200 shadow-md rounded-lg cursor-pointer peer-checked:-500 peer-checked:text-red-500 hover:text-gray-600 hover:bg-gray-100 ">
                                        <div class="block">
